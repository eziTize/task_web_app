...
<div class="container">
    ...
    <div class="section">
        ...
        <div class="row">
            ...
            {!! Form::model($data, ['method' => 'POST','url' => [env('student').'/student-task/'.$data->id.'/send-proof-submit'],'files' => true,'autocomplete' => 'off'],['class' => 'col s12']) !!}
                ...
                <div class="col s12 m12 l12">
                        ...
                        @include('student.g_task.upload_field')
