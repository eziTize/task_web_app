  ...
  <body class="cyan">
    ...
    <div id="login-page" class="row">
      <div class="col s12 z-depth-4 card-panel">
        <form class="login-form" action="{{ Asset(env('teacher').'/login') }}" method="post" autocomplete="off">
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
          <div class="row">
            <div class="input-field col s12 center">
              <img src="{{ Asset('images/login-logo.png') }}" alt="" class="responsive-img valign">
              <p class="center login-form-text"><b>Teacher Panel Login</b></p>
            </div>
          </div>
          ...
          <div class="row">
            <div class="input-field col s12 l6 m6 l8">
              <p class="margin medium-small"><a href="{{ Asset(env('admin').'/login') }}">Login in Admin Panel</a></p>
            </div>
