...
@section('title') {{$teacher->name}}'s Task Reports @endsection
...
<div class="section">
    ...
    <div class="col s12 m12 l12">
      ...
      {!! Form::model($data, ['method' => 'GET','url' => [env('admin').'/team-member-reports/'.$id.'/search'],'files' => true,'autocomplete' => 'off'],['class' => 'col s12']) !!}
